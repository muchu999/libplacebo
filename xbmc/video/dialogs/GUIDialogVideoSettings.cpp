...
void CGUIDialogVideoSettings::InitializeSettings()
{
  ...
  if (renderMethod == RENDER_METHOD_LIBPLACEBO)
  {
	...
	AddSlider(groupColorAjustment, SETTING_VIDEO_BRIGHTNESS, 464, SettingLevel::Basic, videoSettings.m_Brightness, "{:6.2f}", 0.0f, 0.05f, 100.0f, 464, usePopup);
	AddSlider(groupColorAjustment, SETTING_VIDEO_CONTRAST, 465, SettingLevel::Basic, videoSettings.m_Contrast, "{:6.2f}", 0.0f, 0.02f, 100.0f, 465, usePopup);
