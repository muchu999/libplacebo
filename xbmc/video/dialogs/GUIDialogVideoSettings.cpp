...
void CGUIDialogVideoSettings::InitializeToneMappingMenuSdr(CVideoSettings& videoSettings, const std::shared_ptr<CSettingGroup> group)
{
  ...
  {
	AddSlider(group, SETTING_LIB_PLACEBO_SDR_TONE_CONSTANTS_PARAM0, "   Inflection point", SettingLevel::Basic, videoSettings.m_PlaceboSdrToneConstantParam0, "{0:4.1f}", (float) 0.0, (float) 1.0, (float) 255.0);  //cl strings.po...
	AddSlider(group, SETTING_LIB_PLACEBO_SDR_TONE_CONSTANTS_PARAM1, "   Shadow angle", SettingLevel::Basic, videoSettings.m_PlaceboSdrToneConstantParam1, "{0:4.1f}", (float) -89.0, (float) 0.1, (float) 89.0);  //cl strings.po...
	AddSlider(group, SETTING_LIB_PLACEBO_SDR_TONE_CONSTANTS_PARAM2, "   Shadow distance", SettingLevel::Basic, videoSettings.m_PlaceboSdrToneConstantParam2, "{0:4.3f}", (float) 0.005, (float) 0.005, (float) 1.0);  //cl strings.po...
	AddSlider(group, SETTING_LIB_PLACEBO_SDR_TONE_CONSTANTS_PARAM3, "   Inflection height", SettingLevel::Basic, videoSettings.m_PlaceboSdrToneConstantParam3, "{0:4.2f}", (float) -1.0, (float) 0.01, (float) 1.0);  //cl strings.po...
	AddSlider(group, SETTING_LIB_PLACEBO_SDR_TONE_CONSTANTS_PARAM4, "   Mid slope", SettingLevel::Basic, videoSettings.m_PlaceboSdrToneConstantParam4, "{0:4.2f}", (float) -5.0, (float) 0.05, (float) 5.0);  //cl strings.po...
	AddSlider(group, SETTING_LIB_PLACEBO_SDR_TONE_CONSTANTS_PARAM5, "   Highlight distance", SettingLevel::Basic, videoSettings.m_PlaceboSdrToneConstantParam5, "{0:4.3f}", (float) 0.005, (float) 0.005, (float) 1.0);  //cl strings.po...
	AddSlider(group, SETTING_LIB_PLACEBO_SDR_TONE_CONSTANTS_PARAM6, "   Highlight angle", SettingLevel::Basic, videoSettings.m_PlaceboSdrToneConstantParam6, "{0:4.1f}", (float) -89.0, (float) 0.1, (float) 89.0);  //cl strings.po...
